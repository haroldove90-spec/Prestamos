          ...
          {activeReviewContract ? (
            <div className="space-y-4 text-left">
              ...
              >
                ...
                <div className="absolute inset-0 bg-contain bg-center opacity-[0.02] pointer-events-none" style={{ backgroundImage: `url('https://appdesign.appdesignproyectos.com/saldaapp1.png')` }}></div>

                {/* Corporate Header Block */}
                <div className="flex justify-between items-start border-b-2 border-slate-900 pb-4 mb-5">
                  <div className="flex items-center gap-2.5">
                    <img 
                      src="https://appdesign.appdesignproyectos.com/saldaapp1.png" 
                      alt="Salda Logo" 
                ...
                <div className="grid grid-cols-2 gap-6 border-t border-slate-205 pt-6 mt-6 text-[9.5px] font-sans">
                  <div className="text-center">
                    ...
                    <div className="border-t border-slate-400 pt-1 text-slate-700">
                      <strong>LIC. MAYRA MARÍN ALLINAR</strong>
                      <span className="block text-[8px] text-slate-500 font-mono">Apoderada General de Crédito</span>
                    </div>
                  </div>
